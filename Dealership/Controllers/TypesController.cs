...
namespace Dealership.Controllers
{
    ...
    public class TypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "vehicleTypeID,type1")] Models.Type type)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "vehicleTypeID,type1")] Models.Type type)
        {
            if (ModelState.IsValid)
            {
